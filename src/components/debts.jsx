  ...
  return (
    <div className="mx-auto p-4 sm:p-6 md:p-8 max-w-7xl container">
      <div className="mb-6">
        ...
        <p className="text-slate-600 text-sm sm:text-base md:text-lg">Foydalanuvchilarning qarzlari va to‘lovlarini boshqaring</p>
      </div>

      {/* Error Message */}
      {error && (
        <div className="flex items-center bg-red-50 mb-6 p-4 border border-red-200 rounded-lg">
          <svg className="flex-shrink-0 mr-2 w-5 h-5 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="flex sm:flex-row flex-col flex-wrap items-start sm:items-center gap-4 bg-white shadow-sm mb-6 p-4 sm:p-6 border border-slate-200 rounded-2xl">
        <div className="flex-1 w-full sm:min-w-64">
          <label className="block mb-2 font-medium text-slate-700 text-sm">Foydalanuvchi tanlash</label>
          <select
            value={selectedUser}
      ...
      {selectedUser && (
        <div className="bg-white shadow-sm border border-slate-200 rounded-2xl">
          <div className="p-4 sm:p-6 border-slate-200 border-b">
            <h2 className="font-bold text-slate-800 text-lg sm:text-xl">{statusFilter === "took" ? "To‘lanmagan qarzlar" : "To‘langan qarzlar"}</h2>
            <p className="text-slate-600 text-sm sm:text-base">{getUserName(selectedUser)}</p>
          </div>
          ...
          {loading ? (
            ...
            <div className="p-8 sm:p-12 text-center">
              <svg className="mx-auto mb-4 w-12 sm:w-16 h-12 sm:h-16 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                  strokeLinecap="round"
                  ...
                  <div className="flex sm:flex-row flex-col justify-between items-start sm:items-center gap-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="font-bold text-slate-800 text-lg sm:text-2xl">{debt.amount.toLocaleString()} so‘m</span>
                      </div>
                      ...
                      <div className="flex sm:flex-row flex-col gap-2 sm:gap-4 text-slate-500 text-xs sm:text-sm">
                        ...
                        {debt.taken_time && <span>To‘langan: {new Date(debt.taken_time).toLocaleDateString("uz-UZ")}</span>}
                      </div>
                    </div>
                    {debt.status === "took" && (
                      <button
